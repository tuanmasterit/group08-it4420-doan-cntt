...
<script type="text/javascript" src="F:/do_an_g08/Portals/_default/Skins/DarkKnight/DNNMega/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="F:/do_an_g08/Portals/_default/Skins/DarkKnight/DNNMega/jquery.cycle.all.js"></script>
...
<div id="DNN6" class="Home">
    ...
    <div id="Content">
        <div id="Panes">
            <div id="LogoRow">
                <div id="slide">
                    <img style="width:1060px; height:210px;" src="/do_an_g08/Portals/_default/Skins/DarkKnight/Images/1.jpg" alt="Picture 1" />
                    <img style="width:1060px; height:210px;" src="/do_an_g08/Portals/_default/Skins/DarkKnight/Images/3.jpg" alt="Picture 2" />
                </div>
                <div id="slide-nav">
                </div>
